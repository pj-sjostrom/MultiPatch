...
Function	MM_DoSetHeater()
	...
	String	replyStr = MM_SendToHeater("TARGET "+num2str(MM_TempSet*100))
	MM_DoReadHeater()
...
//  Sent this to heater: "SCALE"
//  Received this as a reply: "5.450000".

	// ? - bath, state, heater
	// HT - target
	
	String	tempStr = MM_SendToHeater("?")
	MM_TempBath = Str2Num(StringFromList(0,tempStr,"\t"))/100
	MM_TempHeater = Str2Num(StringFromList(2,tempStr,"\t"))/100

	tempStr = MM_SendToHeater("HT")
